...
from .services.catalog import get_package_path, get_resource_path
...
def datapackage_view(request):
    ...
    datapackage_path = get_package_path(layer_id) / "datapackage.json"
    try:
...
def resource_view(request, layer_id, resource_name):
    resource_path = get_resource_path(layer_id, resource_name)
